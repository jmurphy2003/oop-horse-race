...
The game works the same as before: there are 5 horses (0–4) racing along a 15‑character track. 
Each turn, each horse flips a coin and moves forward one space if it gets heads. 
The race continues until one or more horses reach the end.
